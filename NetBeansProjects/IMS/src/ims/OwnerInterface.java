...
public class OwnerInterface extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        AddEmployee ae = null;
        try {
            ae = new AddEmployee(this,true);
        } catch (SQLException ex) {
            Logger.getLogger(OwnerInterface.class.getName()).log(Level.SEVERE, null, ex);
        }
        ae.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        DeleteEmployee de = null;
        try {
            de = new DeleteEmployee(this,true);
        } catch (SQLException ex) {
            Logger.getLogger(OwnerInterface.class.getName()).log(Level.SEVERE, null, ex);
        }
        de.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        ShowEmployee se =new ShowEmployee(this,true);
        se.setVisible(true);
