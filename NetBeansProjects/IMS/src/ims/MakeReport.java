 ...
 * @author krishna
 */
public class MakeReport extends javax.swing.JDialog {
    ...
    double cost=0;
    IMSdau dau;
    public MakeReport(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        dau = new IMSdau();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int pqnt = Integer.parseInt(quantity);
        ...
        try {
            double OK = dau.getPrice(pid,pqnt);
            if(1 > OK)
            {
            ...
            Logger.getLogger(MakeReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MakeReport dialog = null;
                try {
                    dialog = new MakeReport(new javax.swing.JFrame(), true);
                } catch (SQLException ex) {
                    Logger.getLogger(MakeReport.class.getName()).log(Level.SEVERE, null, ex);
                }
